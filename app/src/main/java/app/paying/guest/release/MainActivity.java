...
public class MainActivity extends AppCompatActivity
    ...
    static int REGISTERED_CALLED = 7880;
        ...
        signOut.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (firebaseAuth.getCurrentUser() != null) {
                    ...
                    //Making the SignOut Button invisible
                    signOut.setVisibility(View.INVISIBLE);
...
//                            Intent i = new Intent(getApplicationContext(), AuthorisationActivity.class);
//                            i.putExtra("source", "registerActivity");
//                            startActivity(i);
                            REGISTERED_CALLED = 7990;
